...
export default async function DashboardPage() {
  ...
  return <div className="shell"><NavBar/><main className="container">
    ...
    <section className="dashboard-grid">
      ...
      <a className="dashboard-card" href="/ranking"><span>03</span><div><h3>Ranking do Bolão</h3><p>Pontos corridos, exatos e mudança de posições.</p><b>Ver ranking →</b></div></a>
      <a className="dashboard-card" href="/bots"><span>04</span><div><h3>Bots explicáveis</h3><p>Veja como cada máquina chegou ao palpite.</p><b>Abrir memórias →</b></div></a>
      <a className="dashboard-card" href="/regulamento"><span>05</span><div><h3>Regulamento</h3><p>Regras executivas, pontuação e mata-mata.</p><b>Consultar regras →</b></div></a>
    </section>
