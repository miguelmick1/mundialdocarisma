...
export default function AdminClient() {
  ...
  return <>
    <section className="admin-launch-grid admin-launch-grid-three">
      ...
      <Link className="admin-launch-card" href="/admin/bots"><span className="admin-launch-icon">🤖</span><div><small>Controle dos bots</small><h3>Palpites dos bots</h3><p>Acompanhe a geração automática de Maria e Pangaré e preencha manualmente Betinho Everyday e Transbot.</p><b>Abrir palpites dos bots →</b></div></Link>
